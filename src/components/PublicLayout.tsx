...
export default function PublicLayout({ children, navigate, currentPage, userRole }: Props) {
  ...
  return (
    <div className="min-h-screen" style={{ background: '#060A12' }}>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            >
              <div
                className="w-8 h-8 rounded-lg flex items-center justify-center gradient-blue-purple"
              >
            ...
            <div className="hidden md:flex items-center gap-8">
              {navLinks.map(link => (
                <button
                  ...
                  style={{ color: currentPage === link.page ? '#3B82F6' : '#94A3B8' }}
                >
                  {link.label}
                </button>
              ))}
        ...
        {mobileOpen && (
          <div
            ...
            style={{ borderColor: 'rgba(59,130,246,0.1)', background: '#0D1421' }}
          >
            {navLinks.map(link => (
              <button
                key={link.page}
            ...
            <div className="pt-2 border-t flex flex-col gap-2" style={{ borderColor: 'rgba(59,130,246,0.1)' }}>
              <button
      ...
      <footer style={{ background: '#060A12', borderTop: '1px solid rgba(59,130,246,0.1)' }}>
        <div className="max-w-7xl mx-auto px-6 py-16">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
            <div className="md:col-span-1">
              <button onClick={() => navigate('landing')} className="flex items-center gap-2 mb-4">
                <div className="w-8 h-8 rounded-lg gradient-blue-purple flex items-center justify-center">
                  <Zap size={16} className="text-white" />
                </div>
                <span className="font-bold text-lg font-display" style={{ color: '#F1F5F9' }}>
                  Smugflex<span className="gradient-text"> AI</span>
                </span>
              </button>
              <p className="text-sm leading-relaxed" style={{ color: '#475569' }}>
                Next-generation AI-powered learning platform helping students across Africa build future-ready skills.
              </p>
            </div>
            <div>
              <h4 className="text-sm font-semibold mb-4" style={{ color: '#F1F5F9' }}>Platform</h4>
              <ul className="space-y-2.5">
                {['Courses', 'AI Tutor', 'Coding Lab', 'Certificates'].map(item => (
                  <li key={item}>
                    <button className="text-sm transition-colors" style={{ color: '#475569' }}
            ...
            <div>
              <h4 className="text-sm font-semibold mb-4" style={{ color: '#F1F5F9' }}>Company</h4>
              <ul className="space-y-2.5">
                {[
            ...
            <div>
              <h4 className="text-sm font-semibold mb-4" style={{ color: '#F1F5F9' }}>Contact</h4>
          ...
          <div
            ...
            style={{ borderTop: '1px solid rgba(59,130,246,0.08)', color: '#475569' }}
          >

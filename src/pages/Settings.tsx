        ...
        <div className="sm:w-48 flex-shrink-0 space-y-1">
          {sections.map(({ icon: Icon, label, id }) => (
            <button
              ...
              style={{
                background:
                  active === id ? "rgba(59,130,246,0.1)" : "transparent",
        ...
        >
            ...
            <div className="space-y-5">
              ...
              {[
                ...
                },
                {
                  ...
                  desc: "Daily tips from your AI tutor",
                },
                {
                  key: "marketing",
                  label: "Promotional Emails",
                  desc: "New courses and offers",
                },
              ].map(({ key, label, desc }) => (
                <div
                  key={key}
                ...
                >
                  ...
                  >
                    <div
                      ...
                      style={{
                        left: notifications[(key as keyof typeof notifications)]
                          ? "22px"
                          : "2px",
                      }}
                    />
          ...
          {active === "privacy" && (
            <div className="space-y-5">
              ...
              {[
                {
                  label: "Show profile in leaderboard",
                  desc: "Your name appears in course rankings",
                  on: true,
                },
                {
                  label: "Share learning progress",
                  desc: "Allow instructors to see your progress",
                  on: true,
                },
                {
                  label: "Public portfolio",
                  desc: "Anyone with link can view your projects",
                  on: false,
                },
              ].map(({ label, desc, on }) => (
                <div

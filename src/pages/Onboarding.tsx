...
const steps = [
  ...
  },
  {
    ...
    options: [
      "Complete beginner",
      "Some basics (followed tutorials)",
      ...
      <div className="min-h-screen mesh-bg flex items-center justify-center px-6">
        <div className="max-w-lg w-full text-center">
          ...
          <p className="mb-8" style={{ color: "#64748B" }}>
            Based on your goals, we have curated the perfect learning path for
            you.
          </p>
            ...
            {[
              {
                title: "Python for AI",
                weeks: "Weeks 1–12",
                reason: "Foundation for your AI Engineer goal",
              },
              {
                title: "Machine Learning Fundamentals",
                weeks: "Weeks 13–28",
                reason: "Core ML skills for your career path",
              },
              {
  ...
  return (
    <div className="min-h-screen mesh-bg flex items-center justify-center px-6 py-12">
      <div className="max-w-lg w-full">
        ...
        >
          <div
            className="h-full rounded-full gradient-blue-purple transition-all duration-500"
        ...
        >
          ...
          <div>
            ...
            <p className="text-sm" style={{ color: "#94A3B8" }}>
              Hi there! I am your personal AI tutor. Let me ask you a few quick
              questions to build your perfect learning path. This takes about 30
              seconds.
            </p>
          </div>
        </div>

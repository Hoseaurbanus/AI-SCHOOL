...
export default function Certificate() {
  ...
  const avgScore = certificateData.length > 0
    ? Math.round(certificateData.reduce((sum, c) => sum + c.score, 0) / certificateData.length)
    : 0;
    ...
    <div className="min-h-screen" style={{ background: '#060A12' }}>
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          ...
          >
            <p className="text-2xl font-bold" style={{ color: '#F1F5F9' }}>{certificateData.length}</p>

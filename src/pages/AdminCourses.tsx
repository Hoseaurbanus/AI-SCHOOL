          ...
          >
            <div className="relative h-32 overflow-hidden">
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(to top,rgba(13,20,33,0.9),transparent)",
                }}
              />
              {course.aiTutor && (
                <div
              ...
              <div
                className="absolute bottom-2 left-2 text-xs px-2 py-0.5 rounded-md"
                style={{
            ...
            <div className="p-3.5">
              ...
              <h3
                className="text-sm font-semibold mb-2 font-display line-clamp-2"
                style={{ color: "#F1F5F9" }}
              >
                {course.title}
              </h3>

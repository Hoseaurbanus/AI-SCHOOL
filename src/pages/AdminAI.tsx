    ...
    <div className="p-4 sm:p-6 lg:p-8 space-y-6">
      <div>
        ...
        <p className="text-sm mt-1" style={{ color: "#64748B" }}>
          Manage AI tutor knowledge bases and instructions
        </p>
      </div>
          ...
          >
            ...
            <div className="space-y-2">
              {[
                ...
                {
                  rule: "Ask comprehension questions after each concept",
                  on: true,
                },
                {
                  rule: "Personalize responses based on student history",
                  on: true,
                },
                {
                  rule: "Use code examples for programming questions",
                  on: true,
                },
              ].map(({ rule, on }) => (

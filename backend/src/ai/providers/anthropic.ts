...
import { AIProvider, ChatMessage, ChatParams, ChatChunk, EmbeddingResult, ModerationResult, ModelInfo } from '../types.js';
...
export class AnthropicProvider implements AIProvider {
  ...
  async moderate(_content: string): Promise<ModerationResult> {
    ...
    throw new Error('Anthropic does not support moderation. Use OpenAI provider.');
  }

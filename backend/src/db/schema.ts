...
export const submissionTypeEnum = pgEnum('submission_type', ['code', 'assignment', 'project']);
export const submissionStatusEnum = pgEnum('submission_status', ['submitted', 'graded', 'returned']);
export const conversationAgentEnum = pgEnum('conversation_agent', ['tutor', 'mentor', 'coder', 'assessor', 'coach']);
export const messageRoleEnum = pgEnum('message_role', ['user', 'assistant', 'system']);
export const memoryCategoryEnum = pgEnum('memory_category', ['session', 'lesson', 'course', 'profile', 'history']);
export const contentTypeEnum = pgEnum('content_type', ['lesson', 'exercise', 'project']);
